...
This rule was **randomly discovered** by the rule generator and showcases a complex, crystalline growth pattern with an underlying 20-step cycle.

<div style="display: flex; justify-content: center; gap: 20px; margin: 20px 0;">
    
    <img src="examples/Period-20_Void-Weaver-E1.png" alt="Void Weaver Early Stage" style="max-width: 48%; height: auto; display: block;">
    
    <img src="examples/Period-20_Void-Weaver-E2.png" alt="Void Weaver Developed Stage" style="max-width: 48%; height: auto; display: block;">
